...
import { AuthChangedFunction, AuthErrorPayload, ChangeEmailParams, ChangeEmailResponse, ChangePasswordParams, ChangePasswordResponse, DeanonymizeParams, DeanonymizeResponse, JWTClaims, JWTHasuraClaims, NhostAuthConstructorParams, NhostSessionResponse, OnTokenChangedFunction, ResetPasswordParams, ResetPasswordResponse, SecurityKey, SendVerificationEmailParams, SendVerificationEmailResponse, SignInParams, SignInResponse, SignOutResponse, SignUpParams, SignUpResponse } from './types';
/**
 * @alias Auth
 */
export declare class HasuraAuthClient {
     ...
     */
    getSession(): import("./types").NhostSession | null;
    /**
     *
