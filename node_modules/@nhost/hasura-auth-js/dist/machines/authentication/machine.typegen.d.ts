export interface Typegen0 {
    ...
    eventsCausingActions: {
        ...
        clearContext: 'done.invoke.passwordlessEmail' | 'done.invoke.passwordlessSms' | 'done.invoke.signUpEmailPassword' | 'done.invoke.signUpSecurityKey';
        clearContextExceptRefreshToken: 'SIGNOUT';
        destroyRefreshToken: 'SESSION_UPDATE' | 'SIGNIN_ANONYMOUS' | 'SIGNIN_MFA_TOTP' | 'SIGNIN_PASSWORD' | 'SIGNIN_SECURITY_KEY_EMAIL' | 'done.invoke.signingOut' | 'error.platform.signingOut' | 'xstate.stop';
        incrementTokenImportAttempts: 'error.platform.importRefreshToken';
        reportSignedIn: '' | 'SESSION_UPDATE' | 'done.invoke.authenticateAnonymously' | 'done.invoke.authenticateUserWithPassword' | 'done.invoke.authenticateUserWithSecurityKey' | 'done.invoke.authenticateWithToken' | 'done.invoke.importRefreshToken' | 'done.invoke.passwordlessSmsOtp' | 'done.invoke.signInMfaTotp' | 'done.invoke.signUpEmailPassword' | 'done.invoke.signUpSecurityKey';
        reportSignedOut: 'SIGNOUT' | 'done.invoke.authenticateUserWithPassword' | 'done.invoke.importRefreshToken' | 'done.invoke.passwordlessEmail' | 'done.invoke.passwordlessSms' | 'done.invoke.signUpEmailPassword' | 'done.invoke.signUpSecurityKey' | 'error.platform.authenticateAnonymously' | 'error.platform.authenticateUserWithPassword' | 'error.platform.authenticateUserWithSecurityKey' | 'error.platform.authenticateWithToken' | 'error.platform.importRefreshToken' | 'error.platform.signInMfaTotp';
        reportTokenChanged: 'SESSION_UPDATE' | 'SIGNIN_ANONYMOUS' | 'SIGNIN_MFA_TOTP' | 'SIGNIN_PASSWORD' | 'SIGNIN_SECURITY_KEY_EMAIL' | 'done.invoke.authenticateAnonymously' | 'done.invoke.authenticateUserWithPassword' | 'done.invoke.authenticateUserWithSecurityKey' | 'done.invoke.authenticateWithToken' | 'done.invoke.importRefreshToken' | 'done.invoke.passwordlessSmsOtp' | 'done.invoke.refreshToken' | 'done.invoke.signInMfaTotp' | 'done.invoke.signUpEmailPassword' | 'done.invoke.signUpSecurityKey' | 'done.invoke.signingOut' | 'error.platform.signingOut' | 'xstate.stop';
        resetErrors: '' | 'PASSWORDLESS_EMAIL' | 'PASSWORDLESS_SMS' | 'PASSWORDLESS_SMS_OTP' | 'SESSION_UPDATE' | 'SIGNIN_ANONYMOUS' | 'SIGNIN_MFA_TOTP' | 'SIGNIN_PASSWORD' | 'SIGNIN_SECURITY_KEY_EMAIL' | 'SIGNUP_EMAIL_PASSWORD' | 'SIGNUP_SECURITY_KEY' | 'done.invoke.authenticateAnonymously' | 'done.invoke.authenticateUserWithPassword' | 'done.invoke.authenticateUserWithSecurityKey' | 'done.invoke.authenticateWithToken' | 'done.invoke.importRefreshToken' | 'done.invoke.passwordlessSmsOtp' | 'done.invoke.signInMfaTotp' | 'done.invoke.signUpEmailPassword' | 'done.invoke.signUpSecurityKey';
        resetTimer: '' | 'SESSION_UPDATE' | 'done.invoke.refreshToken';
        saveAuthenticationError: 'error.platform.authenticateAnonymously' | 'error.platform.authenticateUserWithPassword' | 'error.platform.authenticateUserWithSecurityKey' | 'error.platform.authenticateWithToken' | 'error.platform.importRefreshToken' | 'error.platform.signInMfaTotp' | 'error.platform.signingOut';
        saveMfaTicket: 'done.invoke.authenticateUserWithPassword';
        saveRefreshAttempt: 'error.platform.refreshToken';
        saveRegistrationError: 'error.platform.passwordlessEmail' | 'error.platform.passwordlessSms' | 'error.platform.passwordlessSmsOtp' | 'error.platform.signUpEmailPassword' | 'error.platform.signUpSecurityKey';
        saveSession: 'SESSION_UPDATE' | 'done.invoke.authenticateAnonymously' | 'done.invoke.authenticateUserWithPassword' | 'done.invoke.authenticateUserWithSecurityKey' | 'done.invoke.authenticateWithToken' | 'done.invoke.importRefreshToken' | 'done.invoke.passwordlessSmsOtp' | 'done.invoke.refreshToken' | 'done.invoke.signInMfaTotp' | 'done.invoke.signUpEmailPassword' | 'done.invoke.signUpSecurityKey';
    };
    eventsCausingDelays: {
    ...
    eventsCausingServices: {
        importRefreshToken: 'done.invoke.authenticateWithToken' | 'done.invoke.passwordlessEmail' | 'done.invoke.passwordlessSms' | 'done.invoke.passwordlessSmsOtp' | 'done.invoke.signUpEmailPassword' | 'done.invoke.signUpSecurityKey' | 'error.platform.authenticateWithToken' | 'xstate.after(RETRY_IMPORT_TOKEN_DELAY)#nhost.authentication.retryTokenImport' | 'xstate.init';
    ...
    matchesStates: 'authentication' | 'authentication.authenticating' | 'authentication.authenticating.anonymous' | 'authentication.authenticating.mfa' | 'authentication.authenticating.mfa.totp' | 'authentication.authenticating.password' | 'authentication.authenticating.securityKeyEmail' | 'authentication.retryTokenImport' | 'authentication.signedIn' | 'authentication.signedIn.refreshTimer' | 'authentication.signedIn.refreshTimer.disabled' | 'authentication.signedIn.refreshTimer.idle' | 'authentication.signedIn.refreshTimer.running' | 'authentication.signedIn.refreshTimer.running.pending' | 'authentication.signedIn.refreshTimer.running.refreshing' | 'authentication.signedIn.refreshTimer.stopped' | 'authentication.signedOut' | 'authentication.signedOut.failed' | 'authentication.signedOut.needsMfa' | 'authentication.signedOut.needsSmsOtp' | 'authentication.signedOut.noErrors' | 'authentication.signedOut.signingOut' | 'authentication.signedOut.success' | 'authentication.starting' | 'registration' | 'registration.complete' | 'registration.emailPassword' | 'registration.incomplete' | 'registration.incomplete.failed' | 'registration.incomplete.needsEmailVerification' | 'registration.incomplete.needsOtp' | 'registration.incomplete.noErrors' | 'registration.passwordlessEmail' | 'registration.passwordlessSms' | 'registration.passwordlessSmsOtp' | 'registration.securityKey' | 'token' | 'token.idle' | 'token.idle.error' | 'token.idle.noErrors' | 'token.running' | {
        ...
        registration?: 'complete' | 'emailPassword' | 'incomplete' | 'passwordlessEmail' | 'passwordlessSms' | 'passwordlessSmsOtp' | 'securityKey' | {
